...
async function getAISuggestion(student) {
  ...
  if (missingFields.length === 0) {
    return `Your profile looks complete! Nice work, ${fullName || 'there'}.`;
  }
  return `Hey ${fullName || 'there'}, your profile is missing: ${missingFields.join(', ')}. Adding these helps services like Internship and Job Board find you.`;
}
